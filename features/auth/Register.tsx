          ...
          <div className="w-full max-w-md">
            ...
            <Card>
              <CardHeader className="text-center">
                ...
                <CardDescription>
                  Join our community of caregivers and families
                </CardDescription>
              </CardHeader>
              ...
              <CardContent>
                ...
                <div className="mb-6">
                  ...
                  <div className="grid grid-cols-2 gap-3 mt-2">
                    ...
                    <Button
                      type="button"
                      variant={userType === "caregiver" ? "default" : "outline"}
                      className="h-auto p-4 flex-col space-y-2"
                      onClick={() => setUserType("caregiver")}
                    >
                      <Heart className="h-5 w-5" />
                      <span className="text-sm">Provide Care</span>
                    </Button>
                  </div>
                </div>
                  ...
                  {userType === "caregiver" && (
                    <div className="flex items-start space-x-2">
                      <input
                        ...
                        required
                      />
                      <Label htmlFor="background-check" className="text-sm leading-5">
